...
echo 'add a remote pseudo for the open-api-last repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/open-api-last
